            ...
            <div className={styles.videoSection}>
              <div className={styles.videoWrap} onClick={toggleVideo}>
                <video
                  ...
                  preload="metadata"
                />
                <div className={`${styles.videoOverlay} ${videoPlaying ? styles.hidden : ''}`}>
                  {showTap && <p className={styles.tapHint}>Tap to play</p>}
                ...
                <button className={styles.muteBtn} onClick={toggleMute} title={videoMuted ? 'Unmute' : 'Mute'}>
                  {videoMuted
                ...
                <div className={styles.videoLabel}>
                  <span className={styles.videoLabelCat} style={{ color: cat.color }}>{cat.label}</span>
                  <span className={styles.videoLabelName}>{exercise.name}</span>
                </div>
              </div>
            </div>
          ) : (
