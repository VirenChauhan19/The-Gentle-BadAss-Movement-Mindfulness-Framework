...
import { ensureDirs, VIDEO_DIR, loadEnv } from './env.mjs';

ensureDirs();
const env = loadEnv();

const audit = `# App Feature Audit
...
fs.writeFileSync(path.join(VIDEO_DIR, 'app-feature-audit.md'), audit);
console.log('Wrote marketing-video/app-feature-audit.md');
